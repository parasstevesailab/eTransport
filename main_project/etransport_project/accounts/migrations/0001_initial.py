    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('industrial_owner', 'Industrial Owner'), ('vehicle_owner', 'Vehicle Owner')], max_length=20)),
                ...
                ('company_reg_no', models.CharField(blank=True, max_length=30, null=True)),
