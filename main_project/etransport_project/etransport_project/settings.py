"""
Django settings for etransport_project project.
...
SECRET_KEY = 'django-insecure-p*zg7w(*ewhyvi9t+&=0lmamk-k-73gwtye7vw_)o!&bnn3-%+'
...
WSGI_APPLICATION = 'etransport_project.wsgi.application'
